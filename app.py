...
app = Flask(__name__)
app.secret_key = '123456789'  # TODO: Ändra detta till en slumpmässig hemlig nyckel
...
def login():
    ...
    if request.method == 'POST':
        username = request.form.get("username") # TODO: Hämta det username som POSTats med requesten
        password = request.form.get("password") # TODO: Hämta det password som POSTats med requesten
